...
<head>
    ...
    <script>
        // $(document).ready(addProfilePageReady);
    </script>
...
<body>
    ...
    <div class="container" id="pageContainer">
        <header class="pageHeader">
            ...
            <p>Use this page to register a new customer account to shopping with us.</p>
            </div>
            ...
            <form name="addProfileForm" id="addProfileForm" method="POST" enctype="multipart/form-data">
            ...
            <p></p>
            <p><a class="loginButton" style="margin-top:50px;" onClick="addProfile()">Register</a>
            </p>
            <p></p>
            <p><a class="loginButton" style="margin-top:50px; display:none;" onClick="updateProfile()">Save</a>
            </p>
            </div>
        </header>
